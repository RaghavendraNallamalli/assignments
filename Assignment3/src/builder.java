...
//   .
        ...
        StringBuilder
                q1a = new StringBuilder("StringBuilder" + "");
...
// 2) Insert the following string “insert text” into the string “It is used to _ at the specified index position” at the location denoted by the sign _
        ...
        StringBuilder
                q2a = new StringBuilder("It is used to  at the specified index position");
        System.out.println("Before inserting  :"+q2a+"\n");

        q2a.insert(14, "insert text");
        System.out.println("after inserting  :"+q2a+"\n");

// 3) Reverse the following string “This method returns the reversed object on which it was called” using StringBuilder
// Class

        StringBuilder
                q3a = new StringBuilder
